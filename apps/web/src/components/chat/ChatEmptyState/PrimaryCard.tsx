...
const PrimaryCard = ({
  ...
  <Button
    variant="ghost"
    onClick={onClick}
    className="border-border-tertiary bg-background-primary hover:border-border-secondary flex h-full w-full items-start justify-between gap-4 rounded-lg border px-5 py-4 text-left hover:bg-transparent"
  >
