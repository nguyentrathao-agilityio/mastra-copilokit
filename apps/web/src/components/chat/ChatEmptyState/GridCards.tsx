...
const SmallCard = ({ icon: Icon, title, description, iconClassName, onClick }: SmallCardProps) => (
  <Button
    variant="ghost"
    onClick={onClick}
    className="bg-background-primary hover:border-border-secondary flex h-full w-full flex-col items-start justify-between rounded-lg border px-5 py-4 text-left shadow hover:bg-transparent"
  >
